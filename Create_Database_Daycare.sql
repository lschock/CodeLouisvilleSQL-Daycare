...
--Query using index IX_Parents_LastName_FirstName 
SELECT Parents.*
FROM  Parents
Where LastName = 'Alvarado' and FirstName = 'Valerie'


--Query using index IX_Children_LastName_FirstName
SELECT ChildAge
FROM  Children
WHERE LastName = 'Ada' and FirstName = 'Dane'
